...
import { CheckCircle, Camera, RotateCcw, ExternalLink } from 'lucide-react';
...
const ObjectResults: React.FC<ObjectResultsProps> = ({
  ...
  const confi = Math.round(result.confidence * 100);
    ...
    <div className="max-w-4xl mx-auto">
        ...
        <div className="md:flex">
          ...
          <div className="md:w-1/2 p-8">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className={`px-3 py-1 rounded-full text-sm font-medium ${getConfidenceColor(confi)}`}>
                {confi}% {getConfidenceText(confi)}
              </div>
            </div>
      ...
      <div className="bg-white rounded-xl p-6 shadow-lg mb-8">
        ...
        <p className="text-sm text-slate-600 mt-2">
          {confi >= 80 && "Excellent match! Our AI is very confident about this identification."}
          {confi >= 60 && confi < 80 && "Good match! The AI has moderate confidence in this identification."}
          {confi < 60 && "Uncertain match. Consider taking another photo with better lighting or angle."}
        </p>
      </div>
